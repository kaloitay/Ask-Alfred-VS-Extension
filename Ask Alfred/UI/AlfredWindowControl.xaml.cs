namespace Ask_Alfred.UI
{
    ...
    /// <summary>
    /// Interaction logic for AlfredWindowControl.
    /// </summary>
    public partial class AlfredWindowControl : UserControl
    {
        ...
        public AlfredWindowControl()
        {
            InitializeComponent();
            initializeAlfredWindow();
        }

        private void initializeAlfredWindow()
        {
        ...
        private void createResultItem(IPage i_Page)
        {
            if (i_Page != null)
            {
                Application.Current.Dispatcher.Invoke(() =>
                {
                    AlfredResultUIElement alfredResultUIElement = new AlfredResultUIElement(i_Page, this.Resources);

                    int resultIndex = insertPageToSortedRankArray(i_Page.Rank);
                    resultsListView.Items.Insert(resultIndex, alfredResultUIElement.dockPanel);
                });
            }
        }
